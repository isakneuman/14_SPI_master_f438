...
void init_gpio_hc_sr04(void)
{
	 ...
	 * ---------------------------------------------
	 */
	init_gpio(GPIOA, TRIGG_PIN, GPIO_MODE_ALTER);
	gpio_set_AFR(GPIOA, 8, AF1);
	 ...
	 * ---------------------------------------------
	 */
	init_gpio(GPIOA, ECHO_PIN, GPIO_MODE_ALTER);
	gpio_set_AFR(GPIOA, 6, AF2);
}
